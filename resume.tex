...
\begin{center}
    \textbf{\Huge \scshape Subham Kumar Praharaj} \\ \vspace{1pt}
    \href{mailto:subhampraharaj975@gmail.com}{\underline{subhampraharaj975@gmail.com}} $|$ 
    \href{https://twitter.com/imabptweets}{\underline{@imabptweets}} $|$ 
    \href{https://linkedin.com/in/imabp}{\underline{linkedin.com/in/imabp}} $|$
    \href{https://github.com/imabp}{\underline{Github @skpraharaj}}
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages(Proficient)}{: Dart and Java} \\
      \textbf{Languages(Familiar)}{: C/C++,Javascript, Python, Solidity , Kotlin } \\
     \textbf{Frameworks}{: Flutter, Spring, NodeJs} \\
     \textbf{Developer Tools}{:Google Cloud(VPCs, Load Balancer, BigQuery, Deployment and Monitoring) } \\
    }}
 \end{itemize}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Kalinga University of Industrial Technology}{Bhubaneshwar, Odisha}
      {Senior,B.E in Computer Science and Engineering}{August 2020 -- Expected July. 2024}
  \resumeSubHeadingListEnd
\end{document}
